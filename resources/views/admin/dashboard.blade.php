                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-xl-3">
                                <div class="card-box tilebox-one">
                                    ...
                                    <h3 class="my-3" data-plugin="counterup"><?= @$total_locations; ?></h3>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-xl-3">
                                <div class="card-box tilebox-one">
                                    ...
                                    <h6 class="text-muted text-uppercase mt-0">Daily Commission</h6>
                                    <h3 class="my-3">0.0000</span></h3>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-xl-3">
                                <div class="card-box tilebox-one">
                                    <i class="icon-home float-right m-0 h2 text-muted"></i>
                                    <h6 class="text-muted text-uppercase mt-0">Cash In transit</h6>
                                    <h3 class="my-3" data-plugin="counterup">0.0000</h3>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-xl-8">
                                <div class="card-box">
                                    <h4 class="header-title mb-3">Transaction Statistics</h4>
